...
export const ListItem: Component<Item> = ({ name, url, images, price }) => {
  return (
    <div class="rounded bg-slate-300 dark:bg-slate-900 p-4 border-slate-400 dark:border-slate-800 hover:border-slate-500 dark:hover:border-slate-700 border border-solid grid gap-2 grid-cols-[auto_1fr_auto]">
      ...
      <div class="flex gap-2 flex-1">
        ...
        <div>
          {isNotNil(url) ? (
            <a target="_blank" href={url} class=" text-2xl">
